...
public class PostcardStaxBuilderTest {
    private static PostcardBuilder postcardStaxBuilder;
    ...
    public static void setUp() {
        ...
        postcardStaxBuilder = builderFactory.getPostcardBuilder(ParserType.STAX);
    ...
    public void buildPostcards() throws PostcardException {
        ...
        postcardStaxBuilder.buildPostcards(filePath);
        Set<Postcard> actual = postcardStaxBuilder.getPostcards();
