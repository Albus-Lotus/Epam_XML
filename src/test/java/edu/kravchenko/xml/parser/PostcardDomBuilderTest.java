...
public class PostcardDomBuilderTest {
    private static PostcardBuilder postcardDomBuilder;
    ...
    public static void setUp() {
        ...
        postcardDomBuilder = builderFactory.getPostcardBuilder(ParserType.DOM);
    ...
    public void buildPostcards() throws PostcardException {
        ...
        postcardDomBuilder.buildPostcards(filePath);
        Set<Postcard> actual = postcardDomBuilder.getPostcards();
